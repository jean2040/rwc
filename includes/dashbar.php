        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="../public/studentreg.php">Add Student</a>
                    </li>
                    <li>
                        <a href="morris.html">Students Reports</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Coaches<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
